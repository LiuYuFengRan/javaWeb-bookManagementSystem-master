...
<div>
            ...
            <div>
                <form class="navbar-form navbar-right" role="search">
                    ...
                    <button type="button" class="btn btn-default"
                            <%--pageContext.request.contextPath:JSP中取得绝对路径--%>
                            onclick="javascript:window.location.href='${pageContext.request.contextPath}/login.jsp'">
                        登录
                    </button>
                    <button type="button" class="btn btn-default"
                            onclick="javascript:window.location.href='${pageContext.request.contextPath}/accountregister.jsp'">
                        注册
                    </button>
                </form>
            </div>
    ...
    <div style="padding-left: 82% ; ">
        <ul id="myTab" class="nav nav-tabs">
            <li class="active">
                <a href="#home" data-toggle="tab">图书资源</a>
            </li>
...
<div class="modal fade" id="bookModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <%-- 模态框对话框--%>
    <div class="modal-dialog modal-lg" role="document">
        <%-- 用户点击书籍操作的详细按钮，会将模态框弹出，展示该书籍的详细信息--%>
...
<script>
   ...
   /* 给操作按钮添加events事件*/
    window.operateEvents = {
        /*“click #editBtn” 点击#editBtn button按钮，触发对应的事件，可以传四个参数e, value, row, index*/
        "click #detailBtn": function (e, value, row, index) {   //查看仔细
            /* id选择器选中modal框，且show实例方法被调用时，执行操作*/
