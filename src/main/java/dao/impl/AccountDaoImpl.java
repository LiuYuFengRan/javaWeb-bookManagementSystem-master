...
public class AccountDaoImpl implements AccountDao {
    ...
    public int save(Account account) {
        ...
        String sql="insert into "+ConfigContant.ACCOUNT_TABLE+"(name,password, createTime, status,type,sex,phone,email) values(?,?,?,?,?,?,?,?)";
    ...
    public int upDate(Account account) {
        ...
        String sql="update  "+ConfigContant.ACCOUNT_TABLE+"  set name=?,password=?,createTime=?,status=?,type=?,sex=?,phone=?,email=? where id=?";
        int result = JdbcUtil.upDate(sql,
                account.getName(), account.getPassword(),
                account.getCreateTime(), account.getStatus(),
                account.getType(), account.getSex(), account.getPhone(),
                account.getEmail(),
                account.getId()
        );
        return result;
