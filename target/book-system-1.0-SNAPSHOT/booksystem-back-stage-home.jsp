        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="bs-example bs-example-form" role="form" id="accountform" action="#">
                    <div class="input-group">
                        <span class="input-group-addon" >编号</span>
                        <input type="text" name="id" id="accountid" class="form-control" placeholder="请输入编号" >
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">账户名</span>
                        <input type="text" name="name" id="accountname" class="form-control" placeholder="请输入账户名"  >
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="请输入联系方式"  >
                    </div>
                    <br>
                    <div class="input-group input-group-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="bs-example bs-example-form" role="form" id="newaccountform" action="#">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">密码</span>
                        <input type="password" name="password"  class="form-control"  placeholder="请输入账户密码" required="required">
                    </div>
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon">联系方式</span>
